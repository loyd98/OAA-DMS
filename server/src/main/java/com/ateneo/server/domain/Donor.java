...
public class Donor extends Auditable implements Comparable<Donor>{
    ...
    public void removeMoa(MOA moa) {
        ...
        moa.setDonor(null);
        moa.setForeignDonorAccountNumber(null);
    }
